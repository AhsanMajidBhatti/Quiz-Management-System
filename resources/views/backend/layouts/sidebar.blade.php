                        ...
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="{{ route('user.index') }}"><i class="menu-icon icon-inbox"></i>View User <b class="label green pull-right">
                                    {{ count(App\User::all()) }}</b> </a></li>
                            </ul>

                                                        <!--/.ASSIGN USER SIDEBAR-->

                            <ul class="widget widget-menu unstyled">
                                <li><a href="{{ route('exam.create') }}"><i class="menu-icon icon-bullhorn"></i> Assign User Exam </a>
                                </li>
                                <li><a href="{{ route('exam.view') }}"><i class="menu-icon icon-inbox"></i>View Assign User <b class="label green pull-right">
                                    </b> </a></li>
                            </ul>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                        ...
                                        <i class="menu-icon icon-inbox"></i>{{ __('Logout') }}
                                    </a>
