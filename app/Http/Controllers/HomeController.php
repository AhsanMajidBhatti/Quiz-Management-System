...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $hasQuizCompleted = DB::table('results')->where('user_id', $authUser)->whereIn('quiz_id', (new Quiz)->hasQuizAttempted())->pluck('quiz_id')->toArray();
        
        return view('home', compact('quizzes', 'IsExamAssigned', 'hasQuizCompleted'));
    }
}
